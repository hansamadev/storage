    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("3. Kasa Durumunu Gör");
                Console.WriteLine("4. Borç Durumunu Gör");
                ...
                switch (secim)
                {
                    ...
                    default:
                        Console.ForegroundColor = ConsoleColor.Red;
                        Console.WriteLine("Hatalı seçim! Lütfen geçerli bir seçenek giriniz.");
                        Console.ResetColor();
                        break;
                }
        ...
        static void KasaDurumuGoster()
        {
            ...
            Console.WriteLine($"Mevcut kasa bakiyesi: {kasa:C}");
        }
